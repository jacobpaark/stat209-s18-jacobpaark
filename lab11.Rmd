...
As the mass of the male bird gets bigger, the mass of the egg generally increases with it. 
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  annotate("text", x = 70, y = 2.5, label = "Parrots are in Red")
```
...
The best-fit line matches the visual pattern of the increase in egg mass with the increase of the mass of the male bird. 
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  scale_y_log10() +
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5) +
  annotate("point", x = 218.7, y = 87.00, size = 3, color = "red") +
  annotate("text", x = 218.7, y = 76, label = "Tropicbird")
```
...
```{r}
ggplot(birds, aes(resource, male_mass)) +
  geom_point() +
  annotate("point", x = 0, y = 12800, size = 3, color = "red") +
  annotate("text", x = 0.03, y = 12200, label = "King Penguin has 
    the biggest mass") +
  xlab("Score of Resource Sharing") +
  ylab("Mass of the Male Bird") +
  ggtitle("Score of Resource Sharing by Mass")
```

As the resource sharing score increases, the general mass of the male bird increases. 
