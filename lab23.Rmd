...
**Answer**: This means that around 17.25% resulted in an arrest.
...
**Answer**: This means that 27.52% of crimes was classified as theft.
...
**Answer**: There were 38,816 were theft crimes. 
...
```{r}
38816/sum(ca$num_households)*1000
```

Describe what this means in words.

**Answer**: There are 36.55 crimes per 1000 households. 
...
**Answer**: It is larger. We can safely compare these measurements, because we are summarizing one area to all of Chicago. 
...
**Answer**: It is smaller and can be safely compared. This is the percentage of crimes that are considered to be theft crimes in the area.
...
**Answer**: Larger and cannot be safely compared, because the dataset is much smaller. This shows the number of theft crimes in the area per 1000 households. 
...
```{r}
theft_rate = crimes_ca$theft_sum/crimes_ca$num_households*1000
```
...
**Answer**: There is an outlier of median income of around $60,000 where the theft rate is over 300.
...
**Answer**: One of the reasons is that there area a lot of people that come to the city so that the official numbers are higher. The second reason is there are a lot of traditional gang conflicts. 
